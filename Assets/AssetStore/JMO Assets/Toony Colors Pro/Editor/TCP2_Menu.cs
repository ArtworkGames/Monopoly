...
public static class TCP2_Menu
{
	...
	[MenuItem(MENU_PATH + "Unpack Shaders/All Shaders (Mobile)")]
	static void UnpackAllMobile() { UnpackShaders("mobile"); }
	[MenuItem(MENU_PATH + "Unpack Shaders/All Shaders (Desktop)")]
	...
	[MenuItem(MENU_PATH + "Convert Selected Material(s) from TCP1 to TCP2")]
	...
	[MenuItem(MENU_PATH + "Convert Selected Material(s) from TCP1 to TCP2", true)]
